...
#endif
//======================================Parameters=============================================//
#define LSM9DS1_GYRO_SELF_TEST_MEASURES 10.0f //number of samples to be averaged when performing gyroscope self-test
#define LSM9DS1_ACCEL_SELF_TEST_MEASURES 10.0f //number of samples to be averaged when performing accelerometer self-test
#define LSM9DS1_MAG_SELF_TEST_MEASURES 10.0f //number of samples to be averaged when performing magnetometer self-test
...
class LSM9DS1: public InertialSensor, public AccelerometerSensor, public GyroscopeSensor, public MagnetometerSensor, public ThermometerSensor {
	public:
#ifdef INS_ARDUINO
		...
		LSM9DS1 (SPIDriver* SPI, SPIConfig* spicfg_XG, SPIConfig* spicfg_M);	//constructor
		LSM9DS1 (SPIDriver* SPI, SPIConfig* spicfg_XG, SPIConfig* spicfg_M, ioportid_t gpio_DRDY_G, uint8_t DRDY_pin_G, ioportid_t gpio_DRDY_A, uint8_t DRDY_pin_A, ioportid_t gpio_DRDY_M, uint8_t DRDY_pin_M);	//constructor
#endif		
	...
	private:
		...
		uint8_t _DRDY_pin_G, _DRDY_pin_A, _DRDY_pin_M;	//Data Ready pins
		uint8_t _CTRL1_val_XG, _CTRL6_val_XL, _CTRL3_val_M; //values of the register used when powering up and down the sensor
#ifdef INS_ARDUINO
		uint8_t _chipSelectPin_XG, _chipSelectPin_M;
#elif defined(INS_CHIBIOS)
		SPIDriver* _SPI_int;
        SPIConfig* _spicfg_XG;
        SPIConfig* _spicfg_M;
