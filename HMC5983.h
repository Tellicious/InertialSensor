...
class HMC5983: public InertialSensor, public MagnetometerSensor, public ThermometerSensor {
	public:
#ifdef INS_ARDUINO
		...
		HMC5983 (SPIDriver* SPI, SPIConfig* spicfg);	//constructor
		HMC5983 (SPIDriver* SPI, SPIConfig* spicfg, ioportid_t gpio_DRDY, uint8_t DRDY_pin);	//constructor stm32_gpio_t*
#endif
