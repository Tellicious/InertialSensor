...
//======================================Parameters=============================================//
#define INS_GYRO_AVERAGED_MEASURES 200 //default number of measures used to calibrate the sensor
...
public:
	...
	INS_Gyro(InertialSensor &sensor, float &meas_x, float &meas_y, float &meas_z, INS_orientation orientation); //constructor
